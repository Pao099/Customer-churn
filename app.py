...
app.layout = html.Div([
    html.Div([
        ...
        html.Div(
            [html.H3("Scatterplots"), html.P("Select from the list below to display a scatterplot of correlations:"),
             html.H5("All Data"),
             dcc.Dropdown(
                 id='contdata',
                 value=all_data[11],
        ...
        html.Div([html.H3("Box Plots and Histograms"), html.P("Data Columns:"),
